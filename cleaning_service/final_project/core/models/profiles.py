...
class User(AbstractBaseUser, PermissionsMixin):  # Base user`s model overriding
    ...
    country = models.CharField(verbose_name="Country", max_length=100, null=False)
    city = models.CharField(verbose_name="City", max_length=100, null=False)
    ...
    meter_cost = models.FloatField(verbose_name="Cost per square meter", default=1, validators=(MinValueValidator(0),))
